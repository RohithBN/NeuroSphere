...
export default function Login() {
  ...
  const { signIn, signInWithGoogle, isOnboarded } = useAuth();
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#121212] to-[#1a1a1a] pt-24 pb-12 px-4">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-[10%] right-[20%] w-64 h-64 bg-gradient-radial from-gray-800/20 to-transparent rounded-full blur-3xl opacity-40"></div>
          <div className="absolute bottom-[10%] left-[20%] w-64 h-64 bg-gradient-radial from-gray-800/20 to-transparent rounded-full blur-3xl opacity-40"></div>
        </div>
        ...
        <div className="max-w-md mx-auto relative z-10">
          <div className="bg-black/40 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden shadow-xl">
            ...
            <div className="relative h-32 bg-gradient-to-b from-gray-900/80 to-black/70 flex justify-center items-center">
              <div className="absolute -bottom-9 w-20 h-20 rounded-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center shadow-xl">
            ...
            <div className="px-6 pt-14 pb-8">
              ...
              <p className="mt-8 text-center text-sm text-gray-400">
                ...
                <Link href="/signup" className="font-medium text-white hover:text-gray-200 transition-colors">
                  Sign Up
                </Link>
              </p>
            </div>
          ...
          {/* Decorative elements */}
          <div className="absolute -top-1 -right-1 w-12 h-12 rounded-full bg-white/5 blur-lg"></div>
          <div className="absolute -bottom-8 -left-8 w-28 h-28 rounded-full bg-white/5 blur-xl"></div>
        </div>
      </div>
    </>
  );
